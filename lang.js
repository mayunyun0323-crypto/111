...
footerContact: '联系我们',
        ...
        // 激励排放模块
        emissionSubtitle: '还款激励排放',
        dailyEmission: 'Daily',
        weeklyEmission: 'Weekly',
        todayParticipants: '今日参与人数',
        weekParticipants: '本周参与人数',
        recentRewards: '最近激励',
        received: '获得',
        viewRewardHistory: '查看激励记录',
        repayToEarn: '还款获取激励',
        ...
        repayAmount: '还款金额',
        creditChange: '信用分变动',
        emissionJoined: '已加入激励排放池！',
        dailyEmissionReward: '每日激励',
        weeklyEmissionReward: '每周激励',
        emissionReminder: '分配时间：明日 / 下周一 08:00 (UTC)',
        viewRewards: '查看激励记录',
        done: '完成',
        
        // 激励记录页面
        rewardsPageDesc: '还款即可获得激励排放资格，参与每日及每周的 LISTA 代币分配',
        dailyIncentive: '每日激励',
        weeklyIncentive: '每周激励',
        dailyDistTime: '每日 08:00 (UTC) 分配',
        weeklyDistTime: '每周一 08:00 (UTC) 分配',
        dailyRewards: '每日激励',
        weeklyRewards: '每周激励',
        distDate: '分配日期',
        distWeek: '分配周次',
        recipientAddress: '获得地址',
        rewardAmount: '激励额度',
        claimStatus: '状态',
        claimed: '已领取',
        pendingClaim: '待领取',
        emissionCta: '按时还款即可加入激励排放池，获取 LISTA 代币奖励！',
        goToRepay: '前往还款',
...
footerContact: 'Contact',
        ...
        // Emission module
        emissionSubtitle: 'Repay Incentive Emission',
        dailyEmission: 'Daily',
        weeklyEmission: 'Weekly',
        todayParticipants: 'Today\'s Participants',
        weekParticipants: 'This Week\'s Participants',
        recentRewards: 'Recent Rewards',
        received: 'received',
        viewRewardHistory: 'View Reward History',
        repayToEarn: 'Repay to Earn',
        
        // Repay success emission notice
        repaySuccess: 'Repay Success',
        repaySuccessDesc: 'Your repayment was successful. Thank you!',
        repayAmount: 'Repay Amount',
        creditChange: 'Credit Change',
        emissionJoined: 'Added to emission pool!',
        dailyEmissionReward: 'Daily Incentive',
        weeklyEmissionReward: 'Weekly Incentive',
        emissionReminder: 'Distribution: Tomorrow / Next Monday 08:00 (UTC)',
        viewRewards: 'View Rewards',
        done: 'Done',
        
        // Rewards page
        rewardsPageDesc: 'Repay to qualify for incentive emission, participate in daily and weekly LISTA distribution',
        dailyIncentive: 'Daily Incentive',
        weeklyIncentive: 'Weekly Incentive',
        dailyDistTime: 'Distributed daily at 08:00 (UTC)',
        weeklyDistTime: 'Distributed every Monday at 08:00 (UTC)',
        dailyRewards: 'Daily Rewards',
        weeklyRewards: 'Weekly Rewards',
        distDate: 'Distribution Date',
        distWeek: 'Distribution Week',
        recipientAddress: 'Recipient Address',
        rewardAmount: 'Reward Amount',
        claimStatus: 'Status',
        claimed: 'Claimed',
        pendingClaim: 'Pending',
        emissionCta: 'Repay on time to join the emission pool and earn LISTA tokens!',
